        ...
        b.btnInfoSend.setOnClickListener {
            ...
            if (currentUser != null) {
                ...
                if (edtInfoName.isEmpty() || edtInfoName.length < 3) {
                    Toast.makeText(
                        requireContext(), "Ingrese un nombre válido", Toast.LENGTH_SHORT
                    ).show()
                    ...
                    Toast.makeText(
                        requireContext(), "Ingrese un correo válido", Toast.LENGTH_SHORT
                    ).show()

                } else if (edtInfoPhone.isEmpty() || edtInfoPhone.length < 9) {
                    Toast.makeText(
                        requireContext(), "Ingrese un número válido", Toast.LENGTH_SHORT
                    ).show()
                    ...
                    userInfoSendRef.get().addOnSuccessListener { documentSnapshot ->
                        ...
                        Toast.makeText(
                            requireContext(), "Error al obtener estado de envío", Toast.LENGTH_SHORT
                        ).show()
                    }
                }
            }
